...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import QD_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d4699623-ce05-5c67-980b-2a42053ff8b1"))
platforms = [Pkg.Artifacts.unpack_platform(e, "QD", artifacts_toml) for e in artifacts["QD"]]
...
if best_platform === nothing
    @debug("Unable to load QD; unsupported platform $(triplet(platform_key_abi()))")
else
